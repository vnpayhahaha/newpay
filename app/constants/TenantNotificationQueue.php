...
class TenantNotificationQueue
{
    ...
    public static array $notification_type_list = [
        self::NOTIFICATION_TYPE_SYSTEM => 'tenant_notification_queue.enums.notification_type.1',
        self::NOTIFICATION_TYPE_ORDER  => 'tenant_notification_queue.enums.notification_type.2',
        self::NOTIFICATION_TYPE_BILL   => 'tenant_notification_queue.enums.notification_type.3',
    ];
    ...
    public static array $execute_status_list = [
        self::EXECUTE_STATUS_WAITING   => 'tenant_notification_queue.enums.execute_status.1',
        self::EXECUTE_STATUS_EXECUTING => 'tenant_notification_queue.enums.execute_status.2',
        self::EXECUTE_STATUS_SUCCESS   => 'tenant_notification_queue.enums.execute_status.3',
        self::EXECUTE_STATUS_FAILURE   => 'tenant_notification_queue.enums.execute_status.4',
    ];
