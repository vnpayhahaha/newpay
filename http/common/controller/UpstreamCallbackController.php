...
class UpstreamCallbackController extends BasicController
{
    ...
    public function query_order(Request $request, string $channel_code, int $channel_account_id): Response
    {
        ...
        if ($result['ok']) {
            ...
            $transaction_voucher = '';
            if (isset($result['data']['_upstream_order_no']) && filled($result['data']['_upstream_order_no'])) {
            ...
            if (isset($result['data']['_platform_order_no']) && filled($result['data']['_platform_order_no'])) {
